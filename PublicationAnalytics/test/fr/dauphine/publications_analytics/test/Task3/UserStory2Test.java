...
/*
	...
	*/
	...
	public void questionDMean() {
		...
		assertEquals(1.5, xb.questionDMean(file_name), 0.1);
	}
	@Test
	public void questionEMean() {
		...
		assertEquals(0.25, xb.questionEMean(file_name), 0.1);
	}
	...
	public void questionAMedian() {
		...
		assertEquals(2.5, xb.questionAMedian(file_name), 0.1);
	}
	@Test
	...
	public void questionDMedian() {
		...
		assertEquals(1.0, xb.questionDMedian(file_name), 0.1);
	}
	@Test
